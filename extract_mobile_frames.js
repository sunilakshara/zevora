...
console.log('Extracting mobile frames at 120fps...');

// Extract at 120fps, scale to 720 width for mobile performance, quality 60
const command = `"${ffmpeg}" -i "${videoPath}" -vf "scale=720:-1,fps=120" -vcodec libwebp -q:v 60 "${path.join(outDir, 'frame_%04d.webp')}"`;
