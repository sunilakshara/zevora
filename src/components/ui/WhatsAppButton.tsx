...
export default function WhatsAppButton() {
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-xl hover:bg-[#1ebe57] transition-all hover:scale-110 hover:shadow-2xl"
